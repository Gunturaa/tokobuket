  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-serif font-bold text-stone-900">Tambah Produk Baru</h1>
          <p className="text-stone-500 mt-1">Tambahkan buket baru ke katalog Anda.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-stone-100 shadow-sm">
        <form action={createProduct} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Cth: Buket Mawar Pink"
                />
              </div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-stone-900 mb-2">Foto Produk (Opsional)</label>
